...
interface Translations {
  routes: string; buses: string; buses_online: string;
  schedule: string; stops: string; map: string; sim: string;
  alerts: string; no_alerts: string;
  status: string; route_lbl: string; next_stop: string;
  moving: string; stopped_s: string;
  stop_lbl: string; next_bus: string;
  total_stops: string; total_buses: string; in_motion: string;
  at_stop: string; bus_lbl: string; next: string;
  eta_title: string; eta_ontime: string; eta_delayed: string;
  eta_conf_hi: string; eta_conf_lo: string;
  r1_name: string; r1_desc: string;
  r2_name: string; r2_desc: string;
  r3_name: string; r3_desc: string;
  r4_name: string; r4_desc: string;
  sm: StopMap;
}
...
export function t(lang: Lang, key: keyof Omit<Translations, 'sm'>): string {
  return TR[lang][key];
}
